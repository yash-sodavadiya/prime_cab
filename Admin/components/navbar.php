...
<div class="main-container container-fluid">
    <div class="left-side">
        <ul>
            ...
            <li id="trip" class="<?php echo basename($_SERVER['PHP_SELF']) == 'trip.php' ? 'active' : ''; ?>">
                <img
                ...
                <ul class="sub-menu" id="trip-sub-menu">
                    <li><a href="">Active Trip</a></li>
                    <li><a href="">Complated Trip</a></li>
                    <li><a href="">Booked Trips</a></li>
                </ul>
            </li>
            ...
            <li id="vehicle" class="<?php echo basename($_SERVER['PHP_SELF']) == ('add_vehicle.php' || 'view_vehicle.php' || 'edit_vehicle.php') ? 'active' : ''; ?>">
                <img
